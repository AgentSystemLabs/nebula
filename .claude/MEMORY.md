...
(`.claude/worktrees/workspace-tabs`), unmerged and uncommitted, awaiting the user's verdict. If it is
adopted, [The Workspaces Column Drags To Resize] and the column half of [A Workspaces Column Left Of
Projects] are superseded wholesale — say so then, not before.
...
446 nebula-tui unit + 21 e2e_pty + 6 e2e_tui + 133 daemon green, fmt clean, clippy identical to a stashed
