...
**Did:** Followed the RELEASE SKILL (`.claude/skills/release/SKILL.md`) in a private RELEASE WORKTREE: `1e58372` (feature), `d26ac07`
(memory), `c920b72` (bump to 0.6.0, tagged `v0.6.0`). All 4 matrix targets built, RELEASE NOTES rewritten.

**Gotchas:**
- **"Everything" in the SHARED CHECKOUT was mostly already on `origin/main`.** `ui.rs` and the screenshot were
