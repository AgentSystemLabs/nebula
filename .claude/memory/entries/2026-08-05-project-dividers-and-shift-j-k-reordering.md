...
**Did:** `98dc681` — MOVE PROJECT reordering treats PROJECT DIVIDERS as real positions, and dividers are labelable and movable.
...
and the PROJECTS PANEL began sorting itself by last interaction (RECENCY ORDER; see [Lists Order Themselves]).
